...
public class LibraryMainPage implements MenuConfig {
    ...
    public void showMenu() {
        ...
        while (running) {
            ...
            if (sc.hasNextInt()) {
                ...
                if (libM == 1 || libM == 2 || libM == 3 || libM == 4|| libM == 5) {
    ...
    public boolean menuPages(int selection) {
        ...
        switch (selection) {
            ...
            case 2://book services
                ...
                break;
            case 3:
                UserManagement ump = new UserManagement();
                ump.showMenu();
                break;
            case 4:
                StorageManagement smp = new StorageManagement();
                smp.showMenu();
                break;
            case 5:
